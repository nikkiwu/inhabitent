...
function red_starter_scripts()
{
    ...
    wp_enqueue_script('inhabitent-custom-js', get_template_directory_uri() . '/build/js/custom.min.js', array('jquery', 'inhabitent-skip-link-focus-fix', 'inhabitent-navigation'), '2018', true);
